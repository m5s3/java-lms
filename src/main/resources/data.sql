...
INSERT INTO course (title, creator_id, created_at) VALUES ('TDD, 클린 코드', 1, CURRENT_TIMESTAMP());

INSERT INTO session (title, image, start_date, end_date, course_id, state, type)
    VALUES ('TDD, 클린 코드 1', 'test.jpg', '2025-05-01 15:00:00', '2025-05-02 15:00:00', 1, 'recruiting', 'free');

INSERT INTO session (title, image, start_date, end_date, course_id, state, type)
    VALUES ('TDD, 클린 코드 2', 'test.jpg', '2025-05-02 15:00:00', '2025-05-03 15:00:00', 1, 'ready', 'paid');

INSERT INTO session (title, image, start_date, end_date, course_id, state, type)
    VALUES ('TDD, 클린 코드 3', 'test.jpg', '2025-05-03 15:00:00', '2025-05-04 15:00:00', 1, 'ready', 'free');

INSERT INTO enrollment(student_capacity, fee, session_id, created_at)
    VALUES (0, 0, 1, CURRENT_TIMESTAMP());

INSERT INTO enrollment(student_capacity, fee, session_id, created_at)
    VALUES (10, 10000, 2, CURRENT_TIMESTAMP());
